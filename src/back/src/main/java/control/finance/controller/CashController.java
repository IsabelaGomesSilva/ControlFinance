...
@Autowired
    ...
    public ResponseEntity<CashDto> post(@RequestBody CashRequest entity) {
    ...
    public ResponseEntity<CashDto> put(@PathVariable String id, @RequestBody CashRequest entity) {
