...
@Autowired
    ...
    public ResponseEntity<ExpensesDto> post(@RequestBody CreateExpenses entity) {
    ...
    public ResponseEntity<ExpensesDto> put(@PathVariable String id, @RequestBody UpdateExpenses entity) {
